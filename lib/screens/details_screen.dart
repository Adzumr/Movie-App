...
import 'package:movie_app/utils/toast_alert.dart';
import 'package:sizer/sizer.dart';
import 'package:movie_app/utils/star_calculator.dart' as star_calculator;
...
class DetailsScreen extends StatefulWidget {
  ...
  const DetailsScreen({required this.id, required this.themeColor});
  @override
...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  void initState() {
    ...
    () async {
      ...
      List<Widget> temp2 =
          star_calculator.getStars(rating: temp.rating, starSize: 15.sp);
